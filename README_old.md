...
```
# Site settings
title: Cee Yang                    # 你的博客网站标题
SEOTitle: 杨西川的博客 | Cee Yang Blog		# SEO 标题
description: "Hey"	   	   # 随便说点，描述一下

# SNS settings      
github_username: ceeyang     # 你的github账号
jianshu_username: cc70ff05c89d  # 你的简书ID。
